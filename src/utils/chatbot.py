        ...
        if app_functionality == "Chat":
            ...
            # If we want to use langchain agents for Q&A with our SQL DBs that were created from CSV/XLSX files.
                ...
                agent_executor = create_sql_agent(
                    APPCFG.langchain_llm, db=db, agent_type=None, verbose=True)
                ...
                query_embeddings = list(response)
                ...
                prompt = f'''You will receive the user's question along with the search results of that question over a database. Give the user the proper answer. User's question: {message} \n\n Search results:\n {results} '''
